...
const namePrefix = "BlockHedz";
const description = "My Test BlockHedz Project";
...
const CONTRACT_NAME = 'BlockHedz';
const CONTRACT_SYMBOL = 'BHZ';
...
const PRESALE_WHITELISTED_ADDRESSES = ["0xB74609468Efc527142F92D83c222Ce88d26532F4"]; // only update if you want to manually set the whitelisted addresses
...
const GENERIC_DESCRIPTION = "Which Block Hedz will you get?"; // Replace with what you want the generic descriptions to say.
const GENERIC_IMAGE = "https://ipfs.io/ipfs/bafkreihsnoowq5qfvofaixeh7tfmamkqp62xgey4hd3usjsvpmqpu7vxiu"; // Replace with your generic image that will display for all NFTs pre-reveal.
